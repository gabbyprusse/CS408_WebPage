...
<body>
    ...
    <ul>
        <li> <strong>Be Patient and Consistent:</strong> Remember that progress takes time, so be patient with yourself.
        ...
        <li><strong>Set Realistic Goals:</strong> Begin by setting achievable goals. Whether it's running for a certain distance,
            duration, or simply improving your overall fitness, having clear objectives will keep you motivated.</li>
        <li><strong>Start Slowly:</strong> Don't push yourself too hard initially. Begin with a mix of walking and running intervals.
            Each running interval should be at a pace you can withstand for a while. Training should not be rushed</li>
        <li><strong>Set Realistic Goals:</strong> Begin by setting achievable goals. Whether it's running for a certain distance,
            duration, or simply improving your overall fitness, having clear objectives will keep you motivated.</li>
        <li><strong>Invest in Proper Gear:</strong> Invest in a good pair of running shoes that provide adequate support and
            cushioning. Comfortable clothing made of moisture-wicking materials can also enhance your running experience.</li>
        <li><strong>Listen to Your Body:</strong> Pay attention to how your body feels during and after running. If you experience
        ...
        <li><strong>Find a Good Playlist/Podcast:</strong> Listening to music or a podcast can help stay motivated during a run. The audio
        ...
        <li><strong>Find a Routine:</strong> Establish a consistent running schedule that works for your lifestyle. Whether it's early
            mornings, evenings, or during your lunch break, finding a time that you can stick to will help you stay committed to your
            running routine.</li>
        <li><strong>Stay Hydrated and Nourished:</strong> Drink plenty of water before, during, and after your runs to stay hydrated.
